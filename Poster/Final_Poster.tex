...
\title{Latent Community Detection for Predicting Legislative Roll Call Votes} % Poster title

\author{Elijahu Ben-Michael, Runjing Liu, Jake Soloff } % Author(s)
